...
<body onload="init();">
	<div class="container">
		<div class="row">
			...
			<div class="row">
				<div class="col s12 subcontainer" id="filaprincipal" style="padding:0px 30px;">
					<ul class="fila" id="fila_posto3">
					</ul>
				</div>
				<div class="col s12 l6 subcontainer" id="filapratao" style="padding:0px 30px;">
					<ul class="fila" id="plantao">
					</ul>
				</div>
				<div class="col s12 l6 subcontainer" id="filabiqueira" style="padding:0px 30px;">
